...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	ДобавитьВПроверяемыеРеквизитыВладельца(ПроверяемыеРеквизиты);
КонецПроцедуры

Процедура ДобавитьВПроверяемыеРеквизитыВладельца(ПроверяемыеРеквизиты) 
...
Процедура ОпределитьПутьКФиче()
	...
	КаталогПроекта = ОбщегоНазначениеСервер.ПолучитьКаталогПроекта(Ссылка);
