...
Процедура Синхронизировать(Команда)
	Если ВариантОбъединения = ВариантыОбъединения.Настраиваемый Тогда
...
Процедура СоздатьПользовательскуюИсториюИЗаполнитьНастройкиСинхронизации()
	...
	НоваяПользовательскаяИстория.Владелец = Параметры.БизнесЦель;
	...
	Для Каждого Строка Из НастройкиСинхронизацииНаСервере Цикл
		...
		ИначеЕсли Строка.Поле = Перечисления.ПоляСинхронизации.Персона Тогда
			НоваяПользовательскаяИстория.Персона = Строка.ЗначениеВFeature;
...
Процедура ЗагрузитьТекущийЭлементВНастройки(ТекущаяПользовательскаяИстория)
	...
	Для Каждого Строка Из НастройкиСинхронизацииНаСервере Цикл
		Если Строка.Поле = Перечисления.ПоляСинхронизации.ПользовательскаяИстория Тогда
			Строка.ЗначениеВAgiler = ТекущаяПользовательскаяИстория.Заголовок;
		...
		ИначеЕсли Строка.Поле = Перечисления.ПоляСинхронизации.Персона Тогда
			Строка.ЗначениеВAgiler = ТекущаяПользовательскаяИстория.Персона;
...
ВариантыОбъединения.Вставить("ОбновитьНомерПользовательскойИсторииВФиче", ПредопределенноеЗначение("Перечисление.ВариантыОбъединения.ОбновитьНомерПользовательскойИсторииВФиче"));
ВариантыОбъединения.Вставить("ОбновитьПутьКФичеВПользовательскойИстории", ПредопределенноеЗначение("Перечисление.ВариантыОбъединения.ОбновитьПутьКФичеВПользовательскойИстории"));
